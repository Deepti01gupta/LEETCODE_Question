class Solution {
        ...
        for(int idx=n-1; idx>=0; idx--){
            for(int turn=0; turn<=1; turn++){
                ...
                if(turn==1){
                    ...
                    ans=Math.max(prices[idx] + dp[idx+1][1] , dp[idx+1][0]);
                }
                dp[idx][turn]=ans;
            }
        }
    ...
    //     }
    //     else{
    //         ans=Math.max(arr[idx] + solve(idx+1, 1, arr, dp) , solve(idx+1, 0, arr, dp));
    //     }
    ...
    //     }
    //     else{
    //         ans=Math.max(arr[idx] + solve(idx+1, 1, arr) , solve(idx+1, 0, arr));
    //     }
    //     return ans;
    // }
}